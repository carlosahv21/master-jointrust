  ...
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="/dashboard" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon me-3">
            <img src="{{ asset('public/assets/img/brand/light.svg') }}" height="20" width="20" alt="Volt Logo">
          </span>
      ...
      @if (auth()->user()->role == 'admin')
        ...
        <li class="nav-item {{ Request::segment(1) == 'list-order' || Request::segment(1) == 'orders' ? 'active' : '' }}">
