<?php $__env->startSection('title','Confirmar email'); ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="signin-inner my-3 my-lg-0 bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <p class="mb-4">Recuerda que el enlace es valido por <b>24 horas</b>. 
                                ...
                                <div class="d-grid">
                                    <a href="/deleteUserRegister/<?php echo e($data['email']); ?>" class="btn btn-gray-800">Registrarte</a>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center form-bg-image"
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <div class="d-grid">
                                <a href="/loginUser/<?php echo e(Crypt::encryptString($data['email'].'-'.$data['password'])); ?>" class="btn btn-gray-800">Entrar a Jointrust</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/livewire/confirm-email.blade.php ENDPATH**/ ?>