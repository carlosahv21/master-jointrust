    ...
    <div class="col-12 col-lg-6">
        <div class="card border-0 shadow">
            <div class="card-header border-gray-100 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(asset('/documentation/plugins/sweet-alerts/index.html')); ?>"
    ...
    <div class="col-12 col-lg-6">
        <div class="card border-0 shadow">
            <div class="card-header border-gray-100 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(asset('/documentation/plugins/notifications/index.html')); ?>"
                    class="btn btn-outline-gray-500 d-inline-flex align-items-center" target="_blank">
                    <svg class="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
...
<?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/components/notifications.blade.php ENDPATH**/ ?>