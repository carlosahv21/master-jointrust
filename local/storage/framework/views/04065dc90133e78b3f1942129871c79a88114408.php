    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <div class="row justify-content-center form-bg-image">
                <p class="text-center"><a href="<?php echo e(route('login')); ?>" class="text-gray-700"><i class="fas fa-angle-left me-2"></i> Back to log in</a></p>
...
</main><?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/livewire/reset-password.blade.php ENDPATH**/ ?>