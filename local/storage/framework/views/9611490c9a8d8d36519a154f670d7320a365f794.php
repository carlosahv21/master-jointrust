...
<body>
    ...
    <script>
        ...
        window.addEventListener('goListOrder', event => {
            window.location.href = "<?php echo e(route('list-order')); ?>";
        })
...
</html><?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/layouts/base.blade.php ENDPATH**/ ?>