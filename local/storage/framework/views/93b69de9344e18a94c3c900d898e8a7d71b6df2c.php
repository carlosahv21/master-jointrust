  ...
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <?php if(auth()->user()->role == 'admin'): ?>
        ...
        <li class="nav-item <?php echo e(Request::segment(1) == 'shippings' ? 'active' : ''); ?>">
        ...
        <li class="nav-item <?php echo e(Request::segment(1) == 'list-order' || Request::segment(1) == 'orders' ? 'active' : ''); ?>">
...
</nav><?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/layouts/sidenav.blade.php ENDPATH**/ ?>