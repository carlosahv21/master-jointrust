<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{ asset('public/assets/documentation/components/modals/index.html') }}" class="btn btn-outline-gray" target="_blank"><i class="far fa-question-circle me-1"></i> Modals Docs</a>
        </div>
    </div>
</div>
