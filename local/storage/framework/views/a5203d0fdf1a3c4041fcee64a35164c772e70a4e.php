            ...
            <div class="col-12 mb-4">
                <div class="card shadow border-0 text-center p-0">
                    ...
                    <div class="card-body pb-5">
                        ...
                        <img src="<?php echo e(asset('local/storage/app/images_profile/'.$user->user_image)); ?>" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="<?php echo e($user->first_name ." ". $user->last_name); ?>">
                        <?php else: ?>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            ...
                            <div class="user-avatar xl-avatar">
                                ...
                                <?php elseif($user->user_image): ?>
                                <img class="rounded avatar-xl" src="<?php echo e(asset('local/storage/app/images_profile/'.$user->user_image)); ?>" alt="change avatar" width="100" height="100"> 
                                <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('zFam4KB')) {
    $componentId = $_instance->getRenderedChildComponentId('zFam4KB');
    $componentTag = $_instance->getRenderedChildComponentTagName('zFam4KB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zFam4KB');
} else {
    $response = \Livewire\Livewire::mount('change-pass');
    $html = $response->html();
    $_instance->logRenderedChild('zFam4KB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('QUk2HCc')) {
    $componentId = $_instance->getRenderedChildComponentId('QUk2HCc');
    $componentTag = $_instance->getRenderedChildComponentTagName('QUk2HCc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QUk2HCc');
} else {
    $response = \Livewire\Livewire::mount('guests');
    $html = $response->html();
    $_instance->logRenderedChild('QUk2HCc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
