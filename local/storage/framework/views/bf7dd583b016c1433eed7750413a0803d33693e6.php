...
} elseif ($_instance->childHasBeenRendered('KFQDvWu')) {
    $componentId = $_instance->getRenderedChildComponentId('KFQDvWu');
    $componentTag = $_instance->getRenderedChildComponentTagName('KFQDvWu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KFQDvWu');
} else {
    $response = \Livewire\Livewire::mount('logout', []);
    $html = $response->html();
    $_instance->logRenderedChild('KFQDvWu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></a>
          </div>
...
</nav><?php /**PATH C:\laragon\www\app_laravel_subir\local\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>