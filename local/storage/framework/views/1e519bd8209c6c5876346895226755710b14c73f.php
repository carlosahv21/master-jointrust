    ...
    <div class="row align-items-start p-2">
        ...
        <div class="col-12 p-2">
            <div class="d-xl-flex align-items-center">
                <div>
                    <?php if( $fileProducts ): ?>
                        <img class="rounded avatar-xl" src="<?php echo e($fileProducts->temporaryUrl()); ?>" alt="cambia tu foto">
                    <?php elseif($this->seeFileProducts): ?>
                        <img class="rounded avatar-xl" src="<?php echo e(asset('local/storage/app/images_products/'.$this->seeFileProducts)); ?>" alt="cambia tu foto">
                    <?php else: ?>
                        <img class="rounded avatar-xl" src="<?php echo e(asset('public/assets/img/updivision.png')); ?>" alt="cambia tu foto">
                    <?php endif; ?>
            ...
            <?php if($errors->has('fileProducts')): ?>
                <div class="invalid-feedback">
                    <?php echo e($errors->first('fileProducts')); ?>
...
<?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/livewire/product-form.blade.php ENDPATH**/ ?>