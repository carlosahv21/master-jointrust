 ...
 <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                ...
                <div wire:ignore.self class="row justify-content-center form-bg-image" data-background-lg="<?php echo e(asset('public/assets/img/illustrations/signin.svg')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="<?php echo e(route('login')); ?>" class="fw-bold">Entre aquí</a>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    </main><?php /**PATH /Users/usuario/Sites/app_laravel_subir/local/resources/views/livewire/auth/register.blade.php ENDPATH**/ ?>