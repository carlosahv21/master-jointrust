...
} elseif ($_instance->childHasBeenRendered('Fu1sqJO')) {
    $componentId = $_instance->getRenderedChildComponentId('Fu1sqJO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fu1sqJO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fu1sqJO');
} else {
    $response = \Livewire\Livewire::mount('product-form');
    $html = $response->html();
    $_instance->logRenderedChild('Fu1sqJO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
