...
} elseif ($_instance->childHasBeenRendered('slT6k1K')) {
    $componentId = $_instance->getRenderedChildComponentId('slT6k1K');
    $componentTag = $_instance->getRenderedChildComponentTagName('slT6k1K');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('slT6k1K');
} else {
    $response = \Livewire\Livewire::mount('gift-set-form');
    $html = $response->html();
    $_instance->logRenderedChild('slT6k1K', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
